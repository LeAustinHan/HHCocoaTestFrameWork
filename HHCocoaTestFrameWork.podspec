...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    ...
                    this is HHCocoaTestFrameWork develop by HanHan

                   DESC
  #项目主页地址
  s.homepage     = "https://github.com/LeAustinHan/HHCocoaTestFrameWork.git"
  ...
  #库索引地址
  s.source       = { :git => "https://github.com/LeAustinHan/HHCocoaTestFrameWork.git", :tag => s.version.to_s }

  #需要包含的源文件
  s.source_files  = "HHCocoaTestFrameWork/**/*.{h,m}"
  #需要移除的文件
...
#s.resources = ["HanHan/Resources/*.plist","HanHan/Resources/*.xcassets"]

  # s.resources = "HanHan/Resources/*.plist"
